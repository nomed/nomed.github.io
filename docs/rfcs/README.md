...
- [RFC-0007 — Autonomous maintainer mandate: session-separated delegation and bounded execution](RFC-0007-autonomous-maintainer-mandate.md) (on acceptance, supersedes RFC-0006)
