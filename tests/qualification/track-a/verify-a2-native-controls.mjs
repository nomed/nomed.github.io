...
assert.equal(report.environment_claims.control_provider_egress_attempted, false);
assert.equal(report.environment_claims.control_dependency_bootstrap_observed, false);
...
assert.equal(report.dimensions.provider_local_controls, "PASS");
assert.equal(report.dimensions.dependency_bootstrap_excluded_from_controls, "PASS");
...
assert.equal(report.controls.positive_allow_allow.marker_observed, true);
