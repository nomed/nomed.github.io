...
const work = [
  {
    ...
    focus: "Qualify and explicitly accept a durable audit profile before integrating the approval, provider and recovery stages of a mutation lifecycle. The current profile proposal is governance only.",
    system: "/system/mcp/",
  ...
  },
  {
    ...
    focus: "Yukh Projects v1.7.0 includes a controlled-apply profile qualified with synthetic fixtures. Live qualification, approval and apply remain separate and have not occurred.",
  ...
  },
  {
    ...
    focus: "Reviewed protocol, security-boundary and reproducible OCI preparation evidence is complete. Public publication, live runtime qualification and production readiness remain unproven.",
