...
const work = [
  {
    ...
    status: "Current capability-policy implementation",
    focus: "Preserve the capability decision and evidence boundary while proving that Yukh policy composes with host-native security instead of duplicating or bypassing it.",
    system: "/system/mcp/",
  ...
  },
  {
    ...
    status: "Published GitHub accepted-state adapter",
    focus: "Keep the proven GitHub Projects implementation useful while re-evaluating its architectural role as an adapter for abstract accepted work state rather than a universal Yukh pillar.",
  ...
  },
  {
    ...
    status: "Current coordination-kernel implementation",
    focus: "Preserve claims, conflict, handoff, attribution and replay semantics while allowing transports, workspaces and human interaction surfaces to remain replaceable.",
...
const qualifications = [
  ["Track A / Agent host", "goose + Hermes", "A1 runtime-substrate PASS for both. A2 Yukh/host two-sided policy composition is defined and awaits executable candidate adapters.", "https://github.com/nomed/nomed.github.io/issues/58"],
