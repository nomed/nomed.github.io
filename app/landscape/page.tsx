...
const candidates = [
  ...
  ["goose", "Host candidate — substrate PASS / A2 not executed", "ACP + MCP host with broad composability", "Yukh composition requires internal patching, global auto mode or broader authority"],
  ["Hermes Agent", "Host candidate — substrate PASS / A2 not executed", "Provider-neutral persistent host with ACP, MCP, approvals and multiple execution backends", "Host memory or internal APIs become required Yukh semantics"],
